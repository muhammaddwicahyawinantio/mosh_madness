      ...
      <div className="mx-auto max-w-[1600px] px-4 py-16 md:px-8">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-6">
            <p className="type-headline-lg italic text-primary">{BRAND.name}</p>
          ...
          <nav aria-label="Footer" className="md:col-span-3">
            <p className="type-label mb-4 text-outline">Index</p>
            <ul className="flex flex-col gap-1">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="type-label hover-invert -mx-2 inline-block px-2 py-1 text-on-surface"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-3">
            <p className="type-label mb-4 text-outline">Kontak</p>
            <ul className="flex flex-col gap-1">
              <li>
                <a
                  ...
                  className="type-label hover-invert -mx-2 inline-flex items-center gap-1 px-2 py-1 text-on-surface"
                >
